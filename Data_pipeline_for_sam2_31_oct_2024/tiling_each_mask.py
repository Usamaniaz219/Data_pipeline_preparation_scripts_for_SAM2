...
# root_mask_dir = '/media/usama/SSD/Data_for_SAM2_model_Finetuning/Cities/ct_monroe_city/input/ct_monroe_full_res_masks/'  # Root directory containing subdirectories of masks
# output_dir = '/media/usama/SSD/Data_for_SAM2_model_Finetuning/Cities/ct_monroe_city/output/'  # Output directory for saving the tiles
