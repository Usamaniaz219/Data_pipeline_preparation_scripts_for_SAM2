...
image_dir = '/media/usama/SSD/Data_for_SAM2_model_Finetuning/notebook/training_data_sam2_22/train_data_for_sam2/images/'
mask_dir = '/media/usama/SSD/Data_for_SAM2_model_Finetuning/notebook/training_data_sam2_22/train_data_for_sam2/masks/'
txt_dir = '/media/usama/SSD/Data_for_SAM2_model_Finetuning/notebook/training_data_sam2_22/train_data_for_sam2/txt_files/'
...
FINE_TUNED_MODEL_NAME = "fine_tuned_sam2_6_december_2024"
...
for epoch in range(1, no_of_epochs + 1):
    ...
    for image, mask, input_point, input_label in data_generator_21:
        ...
        # prd_mask_p = prd_mask_p.numpy()
        # cv2.imshow("prd_mask_p",prd_mask_p)
        # cv2.waitKey(0)
        # cv2.destroyAllWindows()
        # print("########")
        # print("prd_masks after the log is applied",torch.log(prd_mask+0.00001))
        # print("prd_masks after the log is applied",-gt_mask)
        # print("prd_masks after the log is applied on the opposite of gt_mask",(1-gt_mask))
        # print("prd_masks after the log is applied on the opposite of gt_mask",torch.log((1 - prd_mask) + 0.00001))
...
#           print("unnorm coords",unnorm_coords.shape)
