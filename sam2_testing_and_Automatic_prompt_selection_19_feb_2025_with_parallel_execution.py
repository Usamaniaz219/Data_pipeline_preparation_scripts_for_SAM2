...
image_path = "/home/usama/test_data_for_sam2_26_feb_2025/data_for_pipeline_to_tile/WE3474/WE3474/outputs/WE3474/step_6_outputs_polygon_merged/image_tiles_/"
dilated_mask_path  = "/home/usama/test_data_for_sam2_26_feb_2025/data_for_pipeline_to_tile/WE3474/WE3474/outputs/WE3474/step_6_outputs_polygon_merged/mask_tiles_/"
org_mask_path = "/home/usama/test_data_for_sam2_26_feb_2025/data_for_pipeline_to_tile/WE3474/WE3474/outputs/WE3474/step_6_outputs/mask_tiles_/"
...
FINE_TUNED_MODEL_WEIGHTS = "17_feb_2025_checkpoints/fine_tuned_sam2_13_feb_2025_with_8_accumulation_steps_90.torch"
...
def calculate_best_iou(gt_dilated_mask, gt_org_mask, no_of_prompt, best_iou, best_seg_map, best_prompt, img1):
    # with semaphore:
...
output_txt_files_dir = "/home/usama/test_data_for_sam2_26_feb_2025/data_for_pipeline_to_tile/WE3474/sam2_outputs/txt_files_with_parrallel_processing_with_denoised_mask"
output_masks_dir ="/home/usama/test_data_for_sam2_26_feb_2025/data_for_pipeline_to_tile/WE3474/sam2_outputs/mask_files_with_parrallel_processing_with_denoised_mask"
...
for idx, (img1, gt_dilated_mask,gt_org_mask, input_points_21, img_name) in enumerate(data_generator_41):
    with torch.no_grad():
        ...
        if iou < lower_bound:
            prompt_list = [1,2,3,4,5,6]
            futures = []
            with concurrent.futures.ThreadPoolExecutor(max_workers=6) as executor:
            # Start the load operations and mark each future with its URL
                for promp in prompt_list:
                    futures.append(executor.submit(calculate_best_iou, gt_dilated_mask, gt_org_mask, promp, best_iou, best_seg_map, best_prompt, img1))
