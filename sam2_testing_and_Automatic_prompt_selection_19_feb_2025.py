...
# image_path = "/media/usama/SSD/Roads_Regions_Classification/Testing_Raw_Data_for_Model_Evaluation/demo129_SwinIR/outputs/demo129_SwinIR/step_6_outputs/image_tiles_/"
# dilated_mask_path  = "/media/usama/SSD/Data_for_SAM2_model_Finetuning/Data_pipeline_for_sam2_31_oct_2024/Updated_codes_before_sam2_inferencing_19_feb_2025_for_noise_removal/demo129_SwinIR_processed/demo129_SwinIR_denoised_masks_Final_after_merging/"
# org_mask_path = "/media/usama/SSD/Data_for_SAM2_model_Finetuning/Data_pipeline_for_sam2_31_oct_2024/Updated_codes_before_sam2_inferencing_19_feb_2025_for_noise_removal/demo129_SwinIR_processed/demo129_SwinIR_denoised_masks_Final_before_merging/"

image_path = "/media/usama/SSD/Data_for_SAM2_model_Finetuning/evaluations_samples_data_for_sam2_2_jan_2025/test_set_20_feb_2025/image_tiles/"
dilated_mask_path  = "/media/usama/SSD/Data_for_SAM2_model_Finetuning/evaluations_samples_data_for_sam2_2_jan_2025/test_set_20_feb_2025/mask_tiles/"
org_mask_path = "/media/usama/SSD/Data_for_SAM2_model_Finetuning/evaluations_samples_data_for_sam2_2_jan_2025/test_set_20_feb_2025/mask_tiles/"
...
def automatic_foreground_prompt_selector_from_image(dilated_mask, org_mask):
    ...
    for contour in contours:
        ...
        if len(foreground_points)> 4:
            selected_indices = np.random.choice(len(foreground_points), 4, replace=False)
...
def testing_loop(input_points):
        ...
        FINE_TUNED_MODEL_WEIGHTS = "17_feb_2025_checkpoints/fine_tuned_sam2_12_december_2024_with_8_accumulation_steps_70.torch"
        # FINE_TUNED_MODEL_WEIGHTS = "fine_tuned_sam2_3_feb_2025_8_accumulations_step_2.torch"
        ...
        # If using checkpoint based approach ##############
        # FINE_TUNED_MODEL_WEIGHTS = torch.load(FINE_TUNED_MODEL_WEIGHTS)
        # predictor.model.load_state_dict(FINE_TUNED_MODEL_WEIGHTS['model_state_dict'])
        ##########################################################################
        
        predictor.model.load_state_dict(torch.load(FINE_TUNED_MODEL_WEIGHTS))

        print(f"{FINE_TUNED_MODEL_WEIGHTS} is loaded!")
...
output_txt_files_dir = "/media/usama/SSD/Data_for_SAM2_model_Finetuning/Evaluation_results_17_feb_2025/txt_files_20_feb_2025_30_itterations_test_set_20_feb_2025_22"
output_masks_dir ="/media/usama/SSD/Data_for_SAM2_model_Finetuning/Evaluation_results_17_feb_2025/mask_files_20_feb_2025_30_itterations_test_set_20_feb_2025_22"
output_images_dir = "/media/usama/SSD/Data_for_SAM2_model_Finetuning/Evaluation_results_17_feb_2025/image_files_20_feb_2025_30_itterations_test_set_20_feb_2025_22"
...
for idx, (img1, gt_dilated_mask,gt_org_mask, input_points_21, img_name) in enumerate(data_generator_41):
    ...
    # cv2.imshow("org_mask.jpg",gt_org_mask)
    # cv2.waitKey(0)
    # cv2.destroyAllWindows()
    ...
    cv2.imwrite(f"{output_images_dir}/{img_name}",img1)
