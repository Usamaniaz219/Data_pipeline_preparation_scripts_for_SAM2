...
def create_directory_structure(image_path, mask_dir):
...
def process_full_pipeline(image_dir, mask_dir, output_base_dir):
...
def process_images(org_map_dir, ms_org_masks_directory, denoise_masks_outputs, merged_denoise_masks_outputs):
